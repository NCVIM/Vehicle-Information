...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2018 at 01:03 PM
...
(1, 2, 1, 'abc', 1234567890, ''),
(1, 3, 2, 'bbb', 1234567890, ''),
...
--
ALTER TABLE `ee`
  MODIFY `EE_Id` int(5) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `se`
  MODIFY `SE_Id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
